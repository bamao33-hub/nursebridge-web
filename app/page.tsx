  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "20px", lineHeight: "1.6" }}>
        Founded by <strong>Dr. Bernadette Amao, DNP</strong>, NurseBridge Consulting
        helps clinicians and healthcare organizations improve workflow efficiency,
      ...
      <div style={{ marginTop: "24px" }}>
        ...
        <p style={{ color: "#9ca3af", marginTop: 10 }}>
          MSN/DNP students: complete a short intake form that opens a pre-filled email to our team.
        </p>
      </div>
      ...
      <p style={{ color: "#9ca3af", marginTop: "60px" }}>© 2026 NurseBridge Consulting</p>
    </main>
  );
}
